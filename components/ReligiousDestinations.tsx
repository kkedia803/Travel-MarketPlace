...
return(
    <section className="py-14 md:py-20 bg-gradient-to-br from-orange-50 via-amber-50/50 to-yellow-50/30 relative overflow-hidden">
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 lg:gap-8 scroll-px-4 -mx-4 px-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:overflow-visible md:mx-0 md:px-0">
            {categories.map((category, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-orange-900/20 via-transparent to-transparent opacity-0 md:group-hover:opacity-100 transition-opacity duration-500" />
                ...
                {/* Hover glow effect */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-orange-400/0 via-amber-400/0 to-yellow-400/0 md:group-hover:from-orange-400/10 md:group-hover:via-amber-400/10 md:group-hover:to-yellow-400/10 transition-all duration-500 pointer-events-none" />
              </Link>
            ))}
          </div>
        </div>
