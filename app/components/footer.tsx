    ...
    return (
        ...
        >
            <motion.footer
                ...
                transition={{ duration: 1.5, ease: [0.33, 1, 0.68, 1], }}
                viewport={{ once: true }}
                className="font-onest relative md:w-full md:px-10 px-5 mx-auto bg-gradient-to-br from-blue-950 via-blue-900 to-blue-950">
                <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        ...
                        > */}
                            <motion.span
                                ...
                                transition={{ duration: 1, ease: [0.33, 1, 0.68, 1] }}
                                viewport={{ once: true }}
                                className='pt-4 font-bulgatti absolute z-0 md:text-[12rem] text-[0rem] opacity-20 tracking-wider bg-clip-text text-white bggradient-to-r from-white via-indigo-100 to-indigo-300 font-medium w-fit cursor-default'>
                    ...
                    <div className=" grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center relative z-10">
